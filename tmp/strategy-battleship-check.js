// src/games/StrategyBattleshipGame.jsx
...
// src/assets/sprites/battleship-radar.svg
var battleship_radar_default = 'data:image/svg+xml,<svg width="256" height="256" viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">%0A  <defs>%0A    <radialGradient id="radarBg" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(128 128) rotate(90) scale(128)">%0A      <stop stop-color="%230EA5E9" stop-opacity="0.36"/>%0A      <stop offset="1" stop-color="%23020617" stop-opacity="0.94"/>%0A    </radialGradient>%0A  </defs>%0A  <circle cx="128" cy="128" r="124" fill="url(%23radarBg)" stroke="%237DD3FC" stroke-opacity="0.45" stroke-width="4"/>%0A  <circle cx="128" cy="128" r="92" stroke="%237DD3FC" stroke-opacity="0.44" stroke-width="2"/>%0A  <circle cx="128" cy="128" r="60" stroke="%237DD3FC" stroke-opacity="0.42" stroke-width="2"/>%0A  <circle cx="128" cy="128" r="28" stroke="%237DD3FC" stroke-opacity="0.4" stroke-width="2"/>%0A  <line x1="128" y1="14" x2="128" y2="242" stroke="%237DD3FC" stroke-opacity="0.42" stroke-width="2"/>%0A  <line x1="14" y1="128" x2="242" y2="128" stroke="%237DD3FC" stroke-opacity="0.42" stroke-width="2"/>%0A  <path d="M128 128L204 72" stroke="%2338BDF8" stroke-width="4" stroke-linecap="round"/>%0A  <circle cx="182" cy="88" r="7" fill="%23EF4444"/>%0A  <circle cx="182" cy="88" r="15" stroke="%23EF4444" stroke-opacity="0.48" stroke-width="3"/>%0A</svg>%0D%0A';

// src/assets/sprites/battleship-frigate.svg
var battleship_frigate_default = 'data:image/svg+xml,<svg width="256" height="128" viewBox="0 0 256 128" fill="none" xmlns="http://www.w3.org/2000/svg">%0A  <defs>%0A    <linearGradient id="hull" x1="24" y1="30" x2="224" y2="98" gradientUnits="userSpaceOnUse">%0A      <stop stop-color="%2393C5FD"/>%0A      <stop offset="1" stop-color="%2360A5FA"/>%0A    </linearGradient>%0A    <linearGradient id="deck" x1="60" y1="16" x2="188" y2="70" gradientUnits="userSpaceOnUse">%0A      <stop stop-color="%23DBEAFE"/>%0A      <stop offset="1" stop-color="%2393C5FD"/>%0A    </linearGradient>%0A  </defs>%0A  <path d="M20 84H236L208 108H52L20 84Z" fill="url(%23hull)" stroke="%23BFDBFE" stroke-opacity="0.8" stroke-width="2"/>%0A  <rect x="58" y="54" width="142" height="26" rx="8" fill="%232563EB" fill-opacity="0.82" stroke="%23BFDBFE" stroke-opacity="0.66"/>%0A  <rect x="94" y="32" width="76" height="26" rx="7" fill="url(%23deck)" stroke="%23BFDBFE" stroke-opacity="0.7"/>%0A  <rect x="126" y="12" width="10" height="20" rx="2" fill="%23E0F2FE"/>%0A  <rect x="96" y="46" width="12" height="6" rx="2" fill="%23F8FAFC"/>%0A  <rect x="116" y="46" width="12" height="6" rx="2" fill="%23F8FAFC"/>%0A  <rect x="136" y="46" width="12" height="6" rx="2" fill="%23F8FAFC"/>%0A  <rect x="156" y="46" width="12" height="6" rx="2" fill="%23F8FAFC"/>%0A  <circle cx="66" cy="96" r="5" fill="%230F172A"/>%0A  <circle cx="190" cy="96" r="5" fill="%230F172A"/>%0A</svg>%0D%0A';

// src/assets/sprites/battleship-ship-carrier.svg
var battleship_ship_carrier_default = 'data:image/svg+xml,<svg width="80" height="28" viewBox="0 0 80 28" fill="none" xmlns="http://www.w3.org/2000/svg">%0A  <defs>%0A    <linearGradient id="carrierHull" x1="8" y1="5" x2="72" y2="24" gradientUnits="userSpaceOnUse">%0A      <stop stop-color="%23334155"/>%0A      <stop offset="1" stop-color="%230F172A"/>%0A    </linearGradient>%0A  </defs>%0A  <path d="M8 18L14 8H70L72 13L64 22H16L8 18Z" fill="url(%23carrierHull)" stroke="%2394A3B8" stroke-width="1.5"/>%0A  <rect x="19" y="10" width="32" height="4" rx="2" fill="%231E293B"/>%0A  <rect x="53" y="9" width="12" height="2.8" rx="1.4" fill="%23CBD5E1"/>%0A  <circle cx="24" cy="20" r="1.4" fill="%23F59E0B"/>%0A  <circle cx="32" cy="20" r="1.4" fill="%2338BDF8"/>%0A  <circle cx="40" cy="20" r="1.4" fill="%2322C55E"/>%0A</svg>%0A';

// src/assets/sprites/battleship-ship-battleship.svg
var battleship_ship_battleship_default = 'data:image/svg+xml,<svg width="80" height="28" viewBox="0 0 80 28" fill="none" xmlns="http://www.w3.org/2000/svg">%0A  <defs>%0A    <linearGradient id="battleHull" x1="12" y1="7" x2="66" y2="23" gradientUnits="userSpaceOnUse">%0A      <stop stop-color="%23475569"/>%0A      <stop offset="1" stop-color="%231E293B"/>%0A    </linearGradient>%0A  </defs>%0A  <path d="M10 18L16 9H64L70 14L63 22H18L10 18Z" fill="url(%23battleHull)" stroke="%2394A3B8" stroke-width="1.5"/>%0A  <rect x="24" y="10" width="22" height="4.5" rx="2.25" fill="%230F172A"/>%0A  <rect x="42" y="8" width="10" height="3" rx="1.5" fill="%2364748B"/>%0A  <rect x="47" y="5.8" width="13" height="1.8" rx="0.9" fill="%23CBD5E1"/>%0A  <circle cx="26" cy="20" r="1.35" fill="%23F97316"/>%0A  <circle cx="35" cy="20" r="1.35" fill="%2338BDF8"/>%0A  <circle cx="44" cy="20" r="1.35" fill="%23F43F5E"/>%0A</svg>%0A';

// src/assets/sprites/battleship-ship-destroyer.svg
var battleship_ship_destroyer_default = 'data:image/svg+xml,<svg width="80" height="28" viewBox="0 0 80 28" fill="none" xmlns="http://www.w3.org/2000/svg">%0A  <defs>%0A    <linearGradient id="destroyerHull" x1="14" y1="7" x2="64" y2="22" gradientUnits="userSpaceOnUse">%0A      <stop stop-color="%231D4ED8"/>%0A      <stop offset="1" stop-color="%231E3A8A"/>%0A    </linearGradient>%0A  </defs>%0A  <path d="M12 18L18 9H58L68 13L62 21H20L12 18Z" fill="url(%23destroyerHull)" stroke="%2393C5FD" stroke-width="1.5"/>%0A  <rect x="26" y="10" width="16" height="4.2" rx="2.1" fill="%23172554"/>%0A  <rect x="40" y="8" width="8" height="3" rx="1.5" fill="%2360A5FA"/>%0A  <rect x="44" y="6" width="10" height="1.6" rx="0.8" fill="%23DBEAFE"/>%0A  <circle cx="27" cy="20" r="1.25" fill="%23FACC15"/>%0A  <circle cx="35" cy="20" r="1.25" fill="%23E2E8F0"/>%0A</svg>%0A';

// src/assets/sprites/battleship-ship-submarine.svg
var battleship_ship_submarine_default = 'data:image/svg+xml,<svg width="80" height="28" viewBox="0 0 80 28" fill="none" xmlns="http://www.w3.org/2000/svg">%0A  <defs>%0A    <linearGradient id="subHull" x1="12" y1="10" x2="66" y2="20" gradientUnits="userSpaceOnUse">%0A      <stop stop-color="%230F766E"/>%0A      <stop offset="1" stop-color="%23134E4A"/>%0A    </linearGradient>%0A  </defs>%0A  <rect x="14" y="12" width="50" height="10" rx="5" fill="url(%23subHull)" stroke="%235EEAD4" stroke-width="1.5"/>%0A  <rect x="35" y="8.5" width="12" height="4" rx="1.8" fill="%2314B8A6"/>%0A  <rect x="46" y="9.2" width="8" height="2.2" rx="1.1" fill="%2399F6E4"/>%0A  <circle cx="23" cy="17" r="1.3" fill="%23E2E8F0"/>%0A  <circle cx="31" cy="17" r="1.3" fill="%23BAE6FD"/>%0A  <circle cx="39" cy="17" r="1.3" fill="%23E2E8F0"/>%0A</svg>%0A';

// src/assets/sprites/battleship-ship-patrol.svg
var battleship_ship_patrol_default = 'data:image/svg+xml,<svg width="80" height="28" viewBox="0 0 80 28" fill="none" xmlns="http://www.w3.org/2000/svg">%0A  <defs>%0A    <linearGradient id="patrolHull" x1="18" y1="9" x2="58" y2="21" gradientUnits="userSpaceOnUse">%0A      <stop stop-color="%237C3AED"/>%0A      <stop offset="1" stop-color="%234C1D95"/>%0A    </linearGradient>%0A  </defs>%0A  <path d="M16 18L22 10H52L60 14L54 21H24L16 18Z" fill="url(%23patrolHull)" stroke="%23C4B5FD" stroke-width="1.5"/>%0A  <rect x="31" y="11" width="11" height="3.5" rx="1.75" fill="%23312E81"/>%0A  <rect x="40" y="9" width="7" height="2.2" rx="1.1" fill="%23DDD6FE"/>%0A  <circle cx="28" cy="19" r="1.15" fill="%23FDE68A"/>%0A  <circle cx="36" cy="19" r="1.15" fill="%23A78BFA"/>%0A</svg>%0A';

// src/games/StrategyBattleshipGame.jsx
var GRID_COLS = 4;
var PLAYER = "player";
var OPPONENT = "opponent";
var AI_DELAY_MS = 1300;
var SHIP_CARDS = [
...
var BASE_HAND_TARGET = 5;
var CARRIER_HAND_TARGET = 7;
var SHIP_ICON_BY_ID = {
  carrier: battleship_ship_carrier_default,
  battleship: battleship_ship_battleship_default,
  destroyer: battleship_ship_destroyer_default,
  submarine: battleship_ship_submarine_default,
  patrol: battleship_ship_patrol_default
};
var COPY_BY_LOCALE = {
  es: {
...
var normalizeLocale = (value) => value === "es" ? "es" : "en";
var otherSide = (side) => side === PLAYER ? OPPONENT : PLAYER;
var resolvePlayerLabel = (side, mode, copy) => {
  if (side === PLAYER)
    return copy.playerOne;
  if (mode === "ai")
    return copy.ai;
  return copy.playerTwo;
};
var shipName = (shipId, locale) => SHIP_CARDS.find((ship) => ship.id === shipId)?.name?.[locale] ?? shipId;
var shipIcon = (shipId) => SHIP_ICON_BY_ID[shipId] ?? battleship_frigate_default;
var isShipPowerActive = (coords, shipId) => coords.some((card) => card.kind === "ship" && card.shipId === shipId && card.revealed && !card.sunk);
var getHandTarget = (coords) => isShipPowerActive(coords, "carrier") ? CARRIER_HAND_TARGET : BASE_HAND_TARGET;
var canWhiteDamageTarget = (attackerHasDestroyer, targetCard) => {
  if (!targetCard || targetCard.kind !== "ship" || targetCard.sunk)
    return false;
  if (targetCard.shipId === "submarine")
    return true;
  return attackerHasDestroyer;
};
var getShipCard = (coords, shipId) => coords.find((card) => card.kind === "ship" && card.shipId === shipId) ?? null;
var shuffle = (values) => {
  const next = [...values];
...
var nextBattleCardId = 1;
var createBattleCard = (payload) => ({ id: `battle-${nextBattleCardId++}`, ...payload });
var nextActionFxId = 1;
var createActionFx = (ownerSide, index, type) => ({ id: nextActionFxId++, ownerSide, index, type });
var createBattleDeck = () => {
  const cards = [];
  for (let i = 0; i < 10; i += 1)
    cards.push(createBattleCard({ type: "white", pegs: 1 }));
  for (let i = 0; i < 6; i += 1)
    cards.push(createBattleCard({ type: "red", pegs: 1 }));
  for (let i = 0; i < 4; i += 1)
    cards.push(createBattleCard({ type: "red", pegs: 2 }));
  for (let i = 0; i < 2; i += 1)
    cards.push(createBattleCard({ type: "red", pegs: 4 }));
...
var coordinateLabel = (index) => {
  const row = Math.floor(index / GRID_COLS);
  const col = index % GRID_COLS;
  return `${String.fromCharCode(65 + col)}-${row + 1}`;
};
var removeCardFromHand = (playerState, cardId) => {
  const card = playerState.hand.find((entry) => entry.id === cardId) ?? null;
  if (!card)
    return { playerState, card: null };
  return {
    card,
    playerState: {
      ...playerState,
...
var discardCardsFromHand = (playerState, cardIds) => {
...
var withCardDiscarded = (playerState, card) => ({
  ...playerState,
  discard: [...playerState.discard, card]
});
var createInitialState = (mode, copy, locale) => ({
  mode,
  phase: "battle",
  handoff: null,
  currentTurn: PLAYER,
...
var countSunkShips = (coords) => coords.filter((card) => card.kind === "ship" && card.sunk).length;
var appendLog = (log, entry) => entry ? [entry, ...log].slice(0, 14) : log;
var getPowerState = (coords) => ({
...
var getPlayableTargets = (state, side, pending) => {
  ...
  if (pending.type === "target-opponent") {
    ...
    return targetCards.filter((card) => !card.sunk && (card.kind === "ship" || !card.revealed)).map((card) => card.index);
  }
  if (pending.type === "target-own" && pending.action === "shield") {
    return targetCards.filter((card) => card.kind === "ship" && card.revealed && !card.sunk).map((card) => card.index);
  }
  if (pending.type === "target-own" && pending.action === "repair") {
    return targetCards.filter((card) => card.kind === "ship" && !card.sunk && card.damage > 0).map((card) => card.index);
  }
  return [];
};
var applyPatrolBoatStartRepair = (state, side, copy, locale) => {
  const ownCoords = state.players[side].coords;
  if (!isShipPowerActive(ownCoords, "patrol"))
    return state;
  const target = [...ownCoords].filter((card) => card.kind === "ship" && card.revealed && !card.sunk && card.damage > 0).sort((a, b) => b.damage - a.damage || a.hp - b.hp)[0];
  if (!target)
    return state;
  const nextCoords = ownCoords.map(
    (card) => card.index === target.index ? {
      ...card,
...
var finishAction = (state, side, cardId, extraPlays, message, logLine, winnerMessage = null, copy = null, locale = "en") => {
...
var applyPegOnCard = (card, pegCount) => {
  if (card.kind !== "ship" || card.sunk)
    return { card, damage: 0, absorbed: 0, sunk: false };
...
var playWhiteOrRed = (state, side, targetIndex, copy, locale, nextMessage = null) => {
  if (!state.pending || state.pending.type !== "target-opponent")
    return state;
  ...
  if (pending.action === "white") {
    ...
    if (!targetCard.revealed) {
      if (targetCard.kind === "ship") {
        logs2.push(copy.logRevealShip(actor, coord, shipName(targetCard.shipId, locale)));
      } else {
        logs2.push(copy.logRevealMiss(actor, coord));
      }
    }
    if (targetCard.kind === "ship" && canWhiteDamageTarget(attackerPowers.destroyer, targetCard)) {
      ...
      if (pegResult.absorbed > 0)
        logs2.push(copy.logShieldAbsorb(coord, pegResult.absorbed));
      if (pegResult.damage > 0)
        logs2.push(copy.logDamage(actor, coord, pegResult.damage));
      if (pegResult.sunk)
        logs2.push(copy.logSunk(actor, shipName(targetCard.shipId, locale)));
    } else {
      updatedTarget = {
        ...targetCard,
        revealed: true
    ...
    logLine = logs2.join(" ");
    const nextCoords2 = enemyCoords.map((card) => card.index === targetIndex ? updatedTarget : card);
    const nextPlayers2 = {
      ...state.players,
      [enemySide]: {
  ...
  if (targetCard.kind === "miss") {
    ...
    if (targetCard.shipId === "submarine") {
      ...
      if (attackerPowers.battleship)
        logs.push(copy.logBattleshipBoost(actor));
      const pegResult = applyPegOnCard({ ...targetCard, revealed: true }, pegs);
      updatedTarget = pegResult.card;
      fxType = pegResult.sunk ? "sunk" : "hit";
      if (pegResult.absorbed > 0)
        logs.push(copy.logShieldAbsorb(coord, pegResult.absorbed));
      if (pegResult.damage > 0)
        logs.push(copy.logDamage(actor, coord, pegResult.damage));
      if (pegResult.sunk)
        logs.push(copy.logSunk(actor, shipName(targetCard.shipId, locale)));
    }
  }
  logLine = logs.join(" ");
...
var playOwnTargetAction = (state, side, targetIndex, copy, locale, nextMessage = null) => {
  if (!state.pending || state.pending.type !== "target-own")
    return state;
  const pending = state.pending;
  const ownCoords = state.players[side].coords;
...
var hasValidTurnAction = (state, side) => {
  const hand = state.players[side].hand;
  const attackerPowers = getPowerState(state.players[side].coords);
  return hand.some((card) => {
    if (card.type === "white") {
      return state.players[otherSide(side)].coords.some(
        (entry) => !entry.sunk && (!entry.revealed || canWhiteDamageTarget(attackerPowers.destroyer, entry))
      );
    }
    if (card.type === "red") {
...
function StrategyBattleshipGame() {
  ...
  const aiTimerRef = useRef2(0);
  const aiFrameRef = useRef2(0);
  const aiLastTsRef = useRef2(0);
  ...
  const resolveCardPlay = useCallback(
    (cardId) => {
      setGame((previous) => {
        if (previous.phase !== "battle" || previous.winner)
          return previous;
        const side = previous.currentTurn;
        if (previous.mode === "ai" && side === OPPONENT)
          return previous;
        if (previous.pending)
          return previous;
        ...
        if (card.type === "white") {
          ...
          if (!targets.length)
            return { ...previous, message: copy.noValidTarget };
  ...
  const resolvePowerChoice = useCallback(
    (choice) => {
      setGame((previous) => {
        if (previous.phase !== "battle" || previous.winner || !previous.pending)
          return previous;
        const side = previous.currentTurn;
        if (previous.mode === "ai" && side === OPPONENT)
          return previous;
        ...
        if (previous.pending.type === "choice-tempo") {
          ...
          if (choice === "discard-white") {
            ...
            if (!whiteCandidates.length)
              return { ...previous, pending: null, message: copy.noValidTarget };
            return {
              ...previous,
  ...
  const toggleDiscardWhiteCard = useCallback((cardId) => {
    setGame((previous) => {
      ...
      if (!card || card.type !== "white" || card.id === previous.pending.cardId)
        return previous;
      const alreadySelected = selected.includes(cardId);
      const nextSelected = alreadySelected ? selected.filter((id) => id !== cardId) : [...selected, cardId];
      return {
        ...previous,
        pending: {
          ...previous.pending,
  ...
  const resolveTargetClick = useCallback(
    (ownerSide, cardIndex) => {
      setGame((previous) => {
        if (previous.phase !== "battle" || !previous.pending || previous.winner)
          return previous;
        const side = previous.currentTurn;
        if (previous.mode === "ai" && side === OPPONENT)
          return previous;
        if (previous.pending.type === "target-opponent") {
          if (ownerSide !== otherSide(side))
            return previous;
  ...
  const continueHandoff = useCallback(() => {
    setGame((previous) => {
      if (previous.phase !== "handoff" || !previous.handoff)
        return previous;
      return {
        ...previous,
        phase: "battle",
  ...
  const runAiTurn = useCallback(() => {
    setGame((previous) => {
      ...
      while (working.phase === "battle" && working.currentTurn === OPPONENT && working.playsLeft > 0 && !working.winner && safety < maxActions) {
        ...
        const revealedShipTargets = enemyCoords.filter((card) => card.kind === "ship" && card.revealed && !card.sunk).sort((a, b) => a.hp - a.damage - (b.hp - b.damage));
        ...
        if (!chosen)
          chosen = aiHand.find((card) => card.type === "white" && (hiddenTargets.length || whiteDamageTargets.length));
        if (!chosen)
          chosen = aiHand.find((card) => card.type === "red" && anyTargets.length);
        if (!chosen)
          chosen = aiHand.find((card) => card.type === "power" && card.power === "shield" && shieldTargets.length);
        if (!chosen)
          chosen = aiHand.find((card) => card.type === "power" && card.power === "repair_or_draw_three");
        if (!chosen)
          chosen = aiHand.find((card) => card.type === "power" && card.power === "discard_or_play_two");
        if (!chosen)
          break;
  ...
  useEffect2(() => {
    const needAi = game.mode === "ai" && game.phase === "battle" && game.currentTurn === OPPONENT && !game.winner && !game.pending;
    if (needAi) {
      if (aiTimerRef.current <= 0) {
  ...
  useEffect2(() => {
    ...
    return () => {
      if (aiFrameRef.current)
        window.cancelAnimationFrame(aiFrameRef.current);
    };
  }, [stepAiClock]);
  ...
  const pendingTargets = game.pending && (game.pending.type === "target-opponent" || game.pending.type === "target-own") ? new Set(getPlayableTargets(game, game.currentTurn, game.pending)) : /* @__PURE__ */ new Set();
  ...
  const discardSelected = pendingType === "discard-white" ? new Set(game.pending.selected ?? []) : /* @__PURE__ */ new Set();
  ...
  const cardLabel = (card) => {
    if (card.type === "white")
      return copy.cardWhite;
    if (card.type === "red")
      return `${copy.cardRed} x${card.pegs ?? 1}`;
    if (card.power === "shield")
      return copy.cardPowerShield;
    if (card.power === "discard_or_play_two")
      return copy.cardPowerTempo;
  ...
  const selectedPendingCard = game.pending?.cardId ? visiblePlayer.hand.find((card) => card.id === game.pending.cardId) ?? null : null;
  const coachHint = pendingType === "target-opponent" || pendingType === "target-own" ? copy.turnGuideTarget : pendingType ? copy.turnGuideChoice : copy.turnGuideIdle;
  ...
  const buildFleetRows = (coords) => SHIP_CARDS.map((ship) => {
  ...
  const getFxClass = (ownerSide, index) => {
    if (!game.lastAction || game.lastAction.ownerSide !== ownerSide || game.lastAction.index !== index)
      return "";
    return `fx-${game.lastAction.type}`;
  };
  const getFxToken = (ownerSide, index) => game.lastAction && game.lastAction.ownerSide === ownerSide && game.lastAction.index === index ? game.lastAction.id : 0;
  return /* @__PURE__ */ React.createElement("div", { className: "mini-game battleship-game" }, /* @__PURE__ */ React.createElement("div", { className: "mini-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h4", null, copy.title), /* @__PURE__ */ React.createElement("p", null, copy.subtitle)), /* @__PURE__ */ React.createElement("div", { className: "battleship-head-actions" }, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => resetGame(game.mode) }, copy.newGame))), /* @__PURE__ */ React.createElement("div", { className: "battleship-toolbar" }, /* @__PURE__ */ React.createElement("div", { className: "battleship-mode-selector" }, /* @__PURE__ */ React.createElement("span", null, copy.mode), /* @__PURE__ */ React.createElement("button", { type: "button", className: game.mode === "ai" ? "active" : "", onClick: () => resetGame("ai") }, copy.modeAi), /* @__PURE__ */ React.createElement("button", { type: "button", className: game.mode === "local" ? "active" : "", onClick: () => resetGame("local") }, copy.modeLocal)), /* @__PURE__ */ React.createElement("div", { className: "battleship-phase-pills" }, /* @__PURE__ */ React.createElement("span", null, `${copy.phaseLabel}: ${phaseText}`), /* @__PURE__ */ React.createElement("span", null, `${copy.turnLabel}: ${resolvePlayerLabel(game.currentTurn, game.mode, copy)}`), /* @__PURE__ */ React.createElement("span", null, `${copy.winnerLabel}: ${game.winner ? resolvePlayerLabel(game.winner, game.mode, copy) : "-"}`), /* @__PURE__ */ React.createElement("span", null, `${copy.cardsLabel}: ${visiblePlayer.hand.length} | ${copy.deckLabel}: ${visiblePlayer.deck.length} | ${copy.reloadLabel}: ${getHandTarget(visiblePlayer.coords)}`), /* @__PURE__ */ React.createElement("span", null, `${copy.sunkLabel}: ${countSunkShips(visibleEnemy.coords)}/${countSunkShips(visiblePlayer.coords)}`))), /* @__PURE__ */ React.createElement("section", { className: "battleship-turn-guide", "aria-live": "polite" }, /* @__PURE__ */ React.createElement("h5", null, copy.turnGuideTitle), /* @__PURE__ */ React.createElement("p", null, coachHint), selectedPendingCard ? /* @__PURE__ */ React.createElement("p", { className: "battleship-selected-card" }, /* @__PURE__ */ React.createElement("strong", null, `${copy.selectedCardLabel}:`), " ", cardLabel(selectedPendingCard)) : null, /* @__PURE__ */ React.createElement("p", { className: "battleship-target-hint" }, copy.validTargetsHint)), /* @__PURE__ */ React.createElement("div", { className: "battleship-rules-panel" }, /* @__PURE__ */ React.createElement("article", null, /* @__PURE__ */ React.createElement("div", { className: "battleship-panel-head" }, /* @__PURE__ */ React.createElement("img", { src: battleship_radar_default, alt: "", "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("h5", null, copy.objectiveTitle)), /* @__PURE__ */ React.createElement("p", null, copy.objective)), /* @__PURE__ */ React.createElement("article", null, /* @__PURE__ */ React.createElement("div", { className: "battleship-panel-head" }, /* @__PURE__ */ React.createElement("img", { src: battleship_frigate_default, alt: "", "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("h5", null, copy.rulesTitle)), /* @__PURE__ */ React.createElement("ul", null, copy.rules.map((rule) => /* @__PURE__ */ React.createElement("li", { key: rule }, rule))))), /* @__PURE__ */ React.createElement("section", { className: "battleship-long-tutorial", "aria-labelledby": "battleship-tutorial-title" }, /* @__PURE__ */ React.createElement("h5", { id: "battleship-tutorial-title" }, copy.tutorialTitle), /* @__PURE__ */ React.createElement("div", { className: "battleship-long-tutorial-body" }, copy.tutorialParagraphs.map((paragraph, index) => /* @__PURE__ */ React.createElement("p", { key: `battleship-tutorial-paragraph-${index}` }, paragraph))), /* @__PURE__ */ React.createElement("div", { className: "battleship-tutorial-playbook" }, /* @__PURE__ */ React.createElement("article", null, /* @__PURE__ */ React.createElement("h6", null, copy.tutorialGoodTitle), /* @__PURE__ */ React.createElement("ul", null, copy.tutorialGoodPlay.map((item, index) => /* @__PURE__ */ React.createElement("li", { key: `battleship-tutorial-good-${index}` }, item)))), /* @__PURE__ */ React.createElement("article", null, /* @__PURE__ */ React.createElement("h6", null, copy.tutorialBadTitle), /* @__PURE__ */ React.createElement("ul", null, copy.tutorialBadPlay.map((item, index) => /* @__PURE__ */ React.createElement("li", { key: `battleship-tutorial-bad-${index}` }, item)))))), game.phase === "handoff" ? /* @__PURE__ */ React.createElement("section", { className: "battleship-handoff-shell", role: "status", "aria-live": "polite" }, /* @__PURE__ */ React.createElement("h5", null, copy.handoffPlacementTitle), /* @__PURE__ */ React.createElement("p", null, handoffText), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: continueHandoff }, copy.continue)) : null, game.phase !== "handoff" ? /* @__PURE__ */ React.createElement("section", { className: "battleship-battle-shell" }, /* @__PURE__ */ React.createElement("div", { className: "battleship-battle-layout" }, /* @__PURE__ */ React.createElement("div", { className: "battleship-board-wrap" }, /* @__PURE__ */ React.createElement("h5", null, copy.enemyGrid), /* @__PURE__ */ React.createElement("div", { className: "battleship-card-grid", role: "grid", "aria-label": copy.enemyGrid }, visibleEnemy.coords.map((card) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("span", { className: "coord-label" }, coordinateLabel(card.index)),
      card.revealed ? card.kind === "ship" ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { className: "battleship-card-ship" }, /* @__PURE__ */ React.createElement("img", { src: shipIcon(card.shipId), alt: "", "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("span", null, shipName(card.shipId, locale))), /* @__PURE__ */ React.createElement("span", { className: "battleship-card-meter" }, /* @__PURE__ */ React.createElement("span", { style: { width: `${Math.max(0, (1 - card.damage / card.hp) * 100)}%` } })), /* @__PURE__ */ React.createElement("small", null, `${copy.damage}: ${card.damage}/${card.hp}`)) : /* @__PURE__ */ React.createElement("span", null, copy.miss) : /* @__PURE__ */ React.createElement("span", null, copy.hidden),
      card.shield > 0 ? /* @__PURE__ */ React.createElement("em", null, `${copy.shield}: ${card.shield}`) : null
    );
  }))), /* @__PURE__ */ React.createElement("div", { className: "battleship-board-wrap" }, /* @__PURE__ */ React.createElement("h5", null, copy.yourGrid), /* @__PURE__ */ React.createElement("div", { className: "battleship-card-grid", role: "grid", "aria-label": copy.yourGrid }, visiblePlayer.coords.map((card) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("span", { className: "coord-label" }, coordinateLabel(card.index)),
      card.kind === "ship" ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { className: "battleship-card-ship" }, /* @__PURE__ */ React.createElement("img", { src: shipIcon(card.shipId), alt: "", "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("span", null, shipName(card.shipId, locale))), /* @__PURE__ */ React.createElement("span", { className: "battleship-card-meter" }, /* @__PURE__ */ React.createElement("span", { style: { width: `${Math.max(0, (1 - card.damage / card.hp) * 100)}%` } })), /* @__PURE__ */ React.createElement("small", null, `${copy.damage}: ${card.damage}/${card.hp}`)) : /* @__PURE__ */ React.createElement("span", null, copy.miss),
      card.shield > 0 ? /* @__PURE__ */ React.createElement("em", null, `${copy.shield}: ${card.shield}`) : null
    );
  })))), /* @__PURE__ */ React.createElement("div", { className: "battleship-fleet-columns" }, /* @__PURE__ */ React.createElement("article", null, /* @__PURE__ */ React.createElement("h5", null, copy.yourHand), /* @__PURE__ */ React.createElement("div", { className: "battleship-hand-row" }, visiblePlayer.hand.map((card) => {
    const canPlayCard = isInteractiveTurn && !game.pending;
    const canToggleDiscard = isInteractiveTurn && pendingType === "discard-white" && card.type === "white" && card.id !== game.pending.cardId;
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("strong", null, cardLabel(card)),
      /* @__PURE__ */ React.createElement("small", null, card.type === "power" ? "POWER" : "BATTLE"),
      selectedForDiscard ? /* @__PURE__ */ React.createElement("small", null, copy.optionSelected) : null
    );
  }))), /* @__PURE__ */ React.createElement("article", null, /* @__PURE__ */ React.createElement("h5", null, copy.yourDeck), /* @__PURE__ */ React.createElement("p", null, visiblePlayer.deck.length), /* @__PURE__ */ React.createElement("h5", null, copy.yourDiscard), /* @__PURE__ */ React.createElement("p", null, visiblePlayer.discard.length)))) : null, /* @__PURE__ */ React.createElement("section", { className: "battleship-fleet-status" }, /* @__PURE__ */ React.createElement("h5", null, copy.fleetStatusTitle), /* @__PURE__ */ React.createElement("div", { className: "battleship-fleet-status-grid" }, /* @__PURE__ */ React.createElement("article", null, /* @__PURE__ */ React.createElement("h6", null, copy.yourFleetStatus), /* @__PURE__ */ React.createElement("ul", null, ownFleetRows.map((ship) => /* @__PURE__ */ React.createElement("li", { key: `own-fleet-${ship.id}` }, /* @__PURE__ */ React.createElement("img", { src: shipIcon(ship.id), alt: "", "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("strong", null, ship.name[locale]), /* @__PURE__ */ React.createElement("span", null, ship.status), ship.card ? /* @__PURE__ */ React.createElement("span", null, `${copy.damage}: ${ship.card.damage}/${ship.card.hp} | ${copy.shield}: ${ship.card.shield ?? 0}`) : null, /* @__PURE__ */ React.createElement("span", null, `${copy.fleetPowerLabel}: ${ship.active ? copy.powerActive : copy.powerInactive}`), /* @__PURE__ */ React.createElement("small", null, ship.powerDescription)))))), /* @__PURE__ */ React.createElement("article", null, /* @__PURE__ */ React.createElement("h6", null, copy.enemyFleetStatus), /* @__PURE__ */ React.createElement("ul", null, enemyFleetRows.map((ship) => /* @__PURE__ */ React.createElement("li", { key: `enemy-fleet-${ship.id}` }, /* @__PURE__ */ React.createElement("img", { src: shipIcon(ship.id), alt: "", "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("strong", null, ship.name[locale]), /* @__PURE__ */ React.createElement("span", null, ship.status), ship.card?.revealed ? /* @__PURE__ */ React.createElement("span", null, `${copy.damage}: ${ship.card.damage}/${ship.card.hp} | ${copy.shield}: ${ship.card.shield ?? 0}`) : null, /* @__PURE__ */ React.createElement("span", null, `${copy.fleetPowerLabel}: ${ship.active ? copy.powerActive : copy.powerInactive}`), /* @__PURE__ */ React.createElement("small", null, ship.powerDescription)))))))), pendingType === "choice-tempo" ? /* @__PURE__ */ React.createElement("div", { className: "battleship-choice-row" }, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => resolvePowerChoice("discard-white") }, copy.optionDiscardWhite), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => resolvePowerChoice("play-two") }, copy.optionPlayTwo)) : null, pendingType === "choice-repair-draw" ? /* @__PURE__ */ React.createElement("div", { className: "battleship-choice-row" }, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => resolvePowerChoice("repair") }, copy.optionRepair), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => resolvePowerChoice("draw-three") }, copy.optionDrawThree)) : null, pendingType === "discard-white" ? /* @__PURE__ */ React.createElement("div", { className: "battleship-choice-row" }, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: confirmDiscardWhite, disabled: !canConfirmDiscard }, copy.confirmDiscardWhite)) : null, game.pending ? /* @__PURE__ */ React.createElement("button", { type: "button", className: "battleship-cancel", onClick: cancelPendingAction }, copy.cancelAction) : null, /* @__PURE__ */ React.createElement("p", { className: "game-message battleship-message" }, game.message), /* @__PURE__ */ React.createElement("p", { className: "battleship-controls" }, game.mode === "ai" && game.currentTurn === OPPONENT ? copy.waitingAi : copy.controls), aiThinking ? /* @__PURE__ */ React.createElement("p", { className: "battleship-ai-wait" }, game.mode === "ai" && game.currentTurn === OPPONENT && game.message && game.message !== copy.chooseCard ? game.message : copy.aiThinking) : null, /* @__PURE__ */ React.createElement("ul", { className: "game-log battleship-log" }, game.log.length ? game.log.map((entry, idx) => /* @__PURE__ */ React.createElement("li", { key: `card-log-${idx}` }, entry)) : /* @__PURE__ */ React.createElement("li", null, copy.chooseCard)));
}
var StrategyBattleshipGame_default = StrategyBattleshipGame;
export {
  StrategyBattleshipGame_default as default
};
