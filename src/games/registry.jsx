...
export const CONTROL_HINTS_BY_LOCALE = {
  es: {
    ...
    "arcade-dig-hole-treasure":    "Juego de cavar hoyo 2D: click cava, A/D o flechas mueven, W/arriba/Espacio salta, J/K/L excavan izq/abajo/der, T coloca antorcha, B activa jetpack, E/Enter interactua con puesto, puerta y tesoro, M abre el puesto, P pausa, R reinicia y F pantalla completa.",
  ...
  en: {
    ...
    "arcade-dig-hole-treasure":    "2D digging run: click digs, A/D or arrows move, W/up/Space jumps, J/K/L dig left/down/right, T places a torch, B triggers the jetpack, E/Enter interacts with outpost, door, and treasure, M opens the market, P pauses, R restarts, and F toggles fullscreen.",
