...
const NbaLegendsDraftGame = lazy(() => import("./sports/nba-legends-draft"));
...
export const GAME_REGISTRY = {
  ...
  "sports-nba-legends-draft":    NbaLegendsDraftGame,
...
export const CONTROL_HINTS_BY_LOCALE = {
  es: {
    ...
    "sports-nba-legends-draft":    "Draft de leyendas NBA por décadas: tira el dado 🎲 para revelar una década, elige 1 de 7 cartas aleatorias y repite hasta tener 8 jugadores. Fija tu quinteto titular (5 de 8) y disputa una temporada regular a una vuelta (15 partidos) más los playoffs NBA (series al mejor de 7, sembrado por récord). Cada partido se resuelve por posesiones comparando los atributos de las cartas y se narra jugada a jugada con marcador en vivo (×1/×2 o ir al final); box score completo al terminar. Todo con ratón/tacto. Cambia idioma ES/EN arriba.",
    ...
    "arcade-retro-space-invaders": "Aegis Meridian: A/D o flechas mueve nave, Espacio dispara, P pausa, R reinicia y F pantalla completa.",
  ...
  en: {
    ...
    "sports-nba-legends-draft":    "Draft NBA legends by decade: roll the die 🎲 to reveal a decade, pick 1 of 7 random cards and repeat until you have 8 players. Set your starting five (5 of 8) and play a single round-robin regular season (15 games) plus the NBA playoffs (best-of-7 series, seeded by record). Each game is resolved possession by possession from the cards' attributes and narrated play-by-play with a live score (×1/×2 or skip to end); full box score afterwards. All mouse/touch. Switch ES/EN language at the top.",
    ...
    "arcade-retro-space-invaders": "Aegis Meridian: A/D or arrows move ship, Space shoots, P pauses, R restarts, F fullscreen.",
