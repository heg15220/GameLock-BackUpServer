...
export const CONTROL_HINTS_BY_LOCALE = {
  es: {
    ...
    "arcade-retro-tetris-blockfall": "Blockudoku: flechas/WASD mueven la pieza activa, Espacio/Enter coloca cuando llega desde la derecha, P pausa, R reinicia y F pantalla completa.",
  ...
  en: {
    ...
    "arcade-retro-tetris-blockfall": "Blockudoku: arrows/WASD move the active piece, Space/Enter places it once it arrives from the right, P pauses, R restarts, F fullscreen.",
