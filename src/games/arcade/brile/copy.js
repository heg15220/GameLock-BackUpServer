...
export const COPY = {
  es: {
    ...
    menuLead:
      "Balón prisionero 6 contra 6 en un cementerio vallado partido por la línea central. Manejas a UN jugador del equipo azul (el resto son IA). Con el balón, pulsa Lanzar y va al rival más peligroso; si le das antes de que bote, queda brilado y va al cementerio de detrás de su campo. Pulsa Atrapar justo cuando te llega un balón para cazarlo al vuelo: no te brilan y te quedas con el balón; o muévete para esquivar. Desde el cementerio también se lanza, y si brilas a un rival vuelves a tu campo. Gana el equipo que deja al rival sin nadie en su campo.",
    // HUD / stage
    teamYou: "Azul (tú)",
    teamRival: "Rojo",
    inCourt: "en campo",
    ...
    hint:
      "Muévete con WASD o las flechas (arrastra sobre el tablero o usa la cruceta en móvil). Con el balón, Espacio/J lanza al rival más peligroso; K/Mayús atrapa (púlsalo justo cuando te llega: te salvas y te quedas el balón). No puedes cruzar la línea central. Enter empieza, P pausa, R reinicia, M sonido y F pantalla completa.",
  },
  en: {
    title: "Dodgeball",
    ...
    hint:
      "Move with WASD or the arrows (drag on the field or use the D-pad on mobile). Holding the ball, Space/J throws at the most dangerous rival; K/Shift catches (press it right as a ball reaches you: you're safe and you keep the ball). You can't cross the centre line. Enter starts, P pauses, R restarts, M sound, and F toggles fullscreen.",
  },
};
