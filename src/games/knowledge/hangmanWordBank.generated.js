...
export const HANGMAN_WORD_BANK_META = {
  "counts": {
    "es": 10000,
    "en": 10000
  },
...
export const HANGMAN_WORD_BANK_LOCALE_LOADERS = {
  "es": () => import("./hangmanWordBankLocales/es.generated.js"),
  "en": () => import("./hangmanWordBankLocales/en.generated.js")
};
...
export const loadHangmanWordBankLocale = async (locale) => {
  const localeKey = normalizeLocaleKey(locale);
  const loader = HANGMAN_WORD_BANK_LOCALE_LOADERS[localeKey];
  if (!loader) return [];
