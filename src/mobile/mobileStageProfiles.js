...
const GAME_STAGE_SELECTORS = {
  ...
  "arcade-paso-a-paso": [".pap-stage"],
  "arcade-el-escondite": [".esc-stage"],
  "arcade-la-comba": [".comba-stage"],
  "arcade-obstaculos-rodantes": [".obst-stage"],
  "arcade-caida-libre": [".caida-stage"],
