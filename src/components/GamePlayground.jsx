...
const KnowledgeGame = lazy(() => import("../games/KnowledgeGame"));
...
const PasoAPasoGame = lazy(() => import("../games/arcade/paso-a-paso"));
const ElEscondideGame = lazy(() => import("../games/arcade/el-escondite"));
const LaCombaGame = lazy(() => import("../games/arcade/la-comba"));
const ObstaculosRodantesGame = lazy(() => import("../games/arcade/obstaculos-rodantes"));
const CaidaLibreGame = lazy(() => import("../games/arcade/caida-libre"));
...
const CONTROL_HINTS_BY_LOCALE = {
  es: {
    ...
    "strategy-poker-holdem-no-bet": "Poker clasico 5 cartas: ciegas, bote y acciones call/raise/fold/all-in. Enter accion principal, U subir, A all-in, F retirarse, 1-5 seleccionar descarte, D descartar, S servirse, N siguiente mano y R reiniciar.",
  ...
  en: {
    ...
    "strategy-poker-holdem-no-bet": "Classic 5-card draw: blinds, pot play, and check/call/raise/fold/all-in decisions. Enter main action, U raise, A all-in, F fold, 1-5 select discard, D discard, S stand pat, N next hand, and R restart.",
