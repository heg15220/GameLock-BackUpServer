...
const CONTROL_HINTS_BY_LOCALE = {
  es: {
    ...
    "arcade-summit-ascent": "Escalada vertical 2D: ↑/W escala, ↓/S baja, ←→/A D mueve lateral, Espacio planta anclaje con piolet, Q bebe agua (+12 stamina), E entra/sale de cueva. Elige montaña entre 3 prototipos. Bandas de viento, niebla, lluvia y nieve drenan estamina más rápido.",
  ...
  en: {
    ...
    "arcade-summit-ascent": "Vertical 2D climbing: ↑/W climbs, ↓/S descends, ←→/A D lateral move, Space plants an ice-axe anchor, Q drinks water (+12 stamina), E enters/leaves a cave. Pick from 3 mountain prototypes. Wind, fog, rain, and snow bands drain stamina faster.",
